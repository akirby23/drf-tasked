...
class TaskDetailViewTests(APITestCase):
    def setUp(self):
        self.user1 = User.objects.create_user(username='aoife', password='vGTdHgV2')
        self.user2 = User.objects.create_user(username='aoife2', password='5htgwhxe')
        self.user3 = User.objects.create_user(username='aoife3', password='4htgwhLe')
        self.category1 = Category.objects.create(name='Work')
        self.category2 = Category.objects.create(name='Education')
        self.priority_level1 = PriorityLevel.objects.create(name='Low')
        self.priority_level2 = PriorityLevel.objects.create(name='High')
