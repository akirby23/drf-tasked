"""
Django settings for drf_tasked project.
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'drf_tasked.serializers.CurrentUserSerializer'
}
...
WSGI_APPLICATION = 'drf_tasked.wsgi.application'
