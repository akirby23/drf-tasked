...
class PriorityLevelListViewTests(APITestCase):
    """
    Tests the priority level list view endpoints
    """
    def setUp(self):
        User.objects.create_superuser(
            username='admin', password='q5vwm5pv'
            )
        User.objects.create_user(
            username='user', password='1mn6ah5d'
            )
...
class PriorityLevelDetailViewTests(APITestCase):
    """
    Tests the priority level detail view endpoints
    """
    def setUp(self):
        ...
        prioritylevel1 = PriorityLevel.objects.create(
            name="Low", description="Low"
            )
        prioritylevel2 = PriorityLevel.objects.create(
